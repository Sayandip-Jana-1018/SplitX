...
| 🚧 5 | Prometheus, Alertmanager, Grafana and Loki on the cluster; alert rules unit-tested; dashboards as code; logs traced by request ID; B-024 traced to the CPU limit with them — [D-052, D-053](docs/DECISIONS.md). Left: the first alert email |
