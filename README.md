...
| **Zero-downtime releases** | `maxSurge: 1, maxUnavailable: 0` with a `preStop` delay so the ingress stops routing before the server shuts down | 2,044 requests during a full pod replacement: 0 lost, 0 non-200 |
